          ...
          <div className="space-y-6 mt-2">
            ...
            {statements.length > 0 && (
              <ul className="space-y-2">
                {statements.map((s) => (
                  <li key={s.id} className="flex items-center gap-3 bg-base-200 rounded-btn px-3 py-2">
            ...
            <div>
              <button type="submit" className="btn btn-primary btn-sm !text-white" disabled={statements.length === 0}>
