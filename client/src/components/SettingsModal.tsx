            ...
            <div>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  disabled={!inElectron}
                />
                <button type="button" className="btn btn-ghost btn-sm" onClick={pickFolder} disabled={!inElectron}>
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  disabled={!inElectron}
                />
                <button type="button" className="btn btn-ghost btn-sm" onClick={pickKey} disabled={!inElectron}>
